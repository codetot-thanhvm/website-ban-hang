...
<?php
	...
	class cart
	{
		...
		public function insertOrder($customer_id){
			...
			if($get_product){
				while($result = $get_product->fetch_assoc()){
					...
					$query = "UPDATE `tbl_product` SET `soluong`= (tbl_product.soluong - '$quantity') WHERE productId = '$productid'";
					$update_sl = $this->db->insert($query);
				}
			}
		...
		public function get_nhaphang(){
			$query = "SELECT * FROM tbl_nhapkho ORDER BY ngay_nhapkho";
			$get_nhaphang = $this->db->select($query);
			return $get_nhaphang;
		}
